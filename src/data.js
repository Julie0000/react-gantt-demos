...
const tasks = [
  {
    id: 1,
    start: new Date(2024, 3, 2, 8),
    end: new Date(2024, 3, 17, 17),
    text: "設備一",
    progress: 30,
    parent: 0,
    type: "summary",
  ...
  },
  {
    id: 10,
    start: new Date(2024, 3, 2, 8),
    end: new Date(2024, 3, 5, 17),
    text: "product AAA-999",
    progress: 100,
    parent: 1,
    type: "task",
  ...
  {
    id: 11,
    start: new Date(2024, 3, 5, 8),
    end: new Date(2024, 3, 7, 17),
    text: "product BBBB-123",
    progress: 90,
    parent: 1,
    type: "task",
  ...
  {
    id: 110,
    start: new Date(2024, 3, 5, 9),
    end: new Date(2024, 3, 5, 10),
    text: "operation 1",
    progress: 100,
    parent: 11,
    type: "progress",
  ...
  {
    id: 112,
    start: new Date(2024, 3, 6, 19),
    end: new Date(2024, 3, 7, 14),
    text: "operation 3",
    progress: 60,
    parent: 11,
    type: "progress",
  ...
  {
    id: 600,
    start: new Date(2024, 3, 9, 8),
    end: new Date(2024, 3, 10, 17),
    text: "故障",
    progress: 0,
    parent: 1,
    type: "urgent",
  ...
  {
    id: 500,
    start: new Date(2024, 3, 11, 8),
    end: new Date(2024, 3, 15, 17),
    text: "設備維修",
    progress: 0,
    parent: 1,
    type: "round",
  ...
  {
    id: 12,
    start: new Date(2024, 3, 20, 12),
    end: new Date(2024, 3, 20, 12),
    text: "預計出貨日期",
    progress: 100,
    parent: 1,
    type: "milestone",
  ...
  {
    id: 21,
    start: new Date(2024, 3, 6, 8),
    end: new Date(2024, 3, 8, 17),
  ...
  {
    id: 31,
    start: new Date(2024, 3, 15, 8),
    end: new Date(2024, 3, 30, 17),
  ...
  {
    id: 5,
    start: new Date(2024, 4, 25, 12),
    end: new Date(2024, 4, 25, 12),
    text: "Release 1.0.0",
    progress: 0,
    parent: 0,
    type: "milestone",
